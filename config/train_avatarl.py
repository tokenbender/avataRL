...
experiment_name = "avatarl_pretrain_250M_adamw_big_critic_shakespeare"
...
# data
dataset = "shakespeare"  # Use openwebtext to match teacher model's training data
...
max_iters = 8017  # Maximum training iterations (set to None to use max_epochs instead)
...
# -----------------------------------------------------------------------------
critic_model_path = 'out/ckpt_regular_pretrain_250M_adamw_big_critic_shakespeare.pt' # Path to the pre-trained critic model
