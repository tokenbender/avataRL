"""Default hyperparameter configuration for train.py.

This file mirrors the original inline defaults so the training script can
load them via the existing configurator mechanism.
"""
